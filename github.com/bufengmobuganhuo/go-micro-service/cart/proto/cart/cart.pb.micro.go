...
type CartService interface {
	...
	DeleteItemID(ctx context.Context, in *CartID, opts ...client.CallOption) (*Response, error)
...
func (c *cartService) DeleteItemID(ctx context.Context, in *CartID, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "Cart.DeleteItemID", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type CartHandler interface {
	...
	DeleteItemID(context.Context, *CartID, *Response) error
...
func RegisterCartHandler(s server.Server, hdlr CartHandler, opts ...server.HandlerOption) error {
	type cart interface {
		...
		DeleteItemID(ctx context.Context, in *CartID, out *Response) error
...
func (h *cartHandler) DeleteItemID(ctx context.Context, in *CartID, out *Response) error {
	return h.CartHandler.DeleteItemID(ctx, in, out)
}
